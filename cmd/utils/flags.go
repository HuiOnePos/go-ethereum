...
var (
	...
	BootnodesFlag = cli.StringFlag{
		Name:  "bootnodes",
		Usage: "Comma separated p2pay URLs for P2P discovery bootstrap (set v4+v5 instead for light servers)",
		Value: "",
	}
	BootnodesV4Flag = cli.StringFlag{
		Name:  "bootnodesv4",
		Usage: "Comma separated p2pay URLs for P2P v4 discovery bootstrap (light server, full nodes)",
		Value: "",
	}
	BootnodesV5Flag = cli.StringFlag{
		Name:  "bootnodesv5",
		Usage: "Comma separated p2pay URLs for P2P v5 discovery bootstrap (light server, light nodes)",
		Value: "",
	}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	for _, url := range urls {
		...
		if err != nil {
			log.Error("Bootstrap URL invalid", "p2pay", url, "err", err)
			continue
		}
